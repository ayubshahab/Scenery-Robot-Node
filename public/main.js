...
function toggleModalOn() {
  document.getElementById("modalOuter").style.display = "flex";
}

function toggleModalOff() {
  document.getElementById("modalOuter").style.display = "none";
}
window.onclick = function (event) {
  if (event.target == document.getElementById("modalOuter")) {
    document.getElementById("modalOuter").style.display = "none";
  }
  if (event.target == document.getElementById("pathImgCont")) {
    document.getElementsByClassName("pathImgCont")[0].style.zIndex = "101";
    document.getElementsByClassName("rightSide")[0].style.zIndex = "100";
  }
  if (event.target == document.getElementById("rightSide")) {
    document.getElementsByClassName("pathImgCont")[0].style.zIndex = "100";
    document.getElementsByClassName("rightSide")[0].style.zIndex = "101";
  }
  ...
  var features = ["type1", "type2", "type3", "type4"];
  for (var i = 0; i < features.length; i++) {
    if (feat[i] == temp.className) {
      if (
        ...
        document.getElementsByClassName(feat[i])[0].style.color = "black";
      } else {
        document.getElementsByClassName(features[i])[0].style.display = "flex";
        document.getElementsByClassName(feat[i])[0].style.color = "#f05627";
      }
    } else {
      if (feat.includes(temp.className)) {
        document.getElementsByClassName(features[i])[0].style.display = "none";
        document.getElementsByClassName(feat[i])[0].style.color = "black";
      }
    }
...
//going left and right int the img scroll whell in the grid funciton
function scrollRight(){
  document.getElementById("gridWheel").scrollLeft += 200;
}
...
document.getElementById("leftButton").onmousedown = function () {
  leftRightTimer = setInterval(function () {
    document.getElementById("gridWheel").scrollLeft -= 5;
  }, 1);
};
